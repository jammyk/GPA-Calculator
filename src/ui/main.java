...
public class main {
    ...
    private static void loadCourses() {
        ...
        Course cpsc110 = new Course("CPSC110", 4, 83, firstYearTermOne);
        Course chem111 = new Course("CHEM111", 4, 72, firstYearTermOne);
        Course engl110 = new Course("ENGL110", 3, 72, firstYearTermOne);
        Course eosc112 = new Course("EOSC112", 3, 96, firstYearTermOne);
        ...
        Course math101 = new Course("MATH101", 3, 77, firstYearTermTwo);
        Course ling100 = new Course("LING100", 3, 85, firstYearTermTwo);
        Course engl100 = new Course("ENGL100", 3, 69, firstYearTermTwo);
        ...
        Course cpsc210 = new Course("CPSC210", 4, 88, secondYearTermOne);
        Course phil120 = new Course("PHIL120", 3, 82, secondYearTermOne);
        Course stat200 = new Course("STAT200", 3, 87, secondYearTermOne);
        Course comm465 = new Course("COMM465", 3,87,  secondYearTermOne);
        Course chin131 = new Course("CHIN131", 3, 91, secondYearTermOne);
